...
#ifndef TRUEFACELIVENESS_SWIFT_H
#define TRUEFACELIVENESS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TrueFaceLiveness",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC16TrueFaceLiveness30TrueFaceLivenessViewController")
@interface TrueFaceLivenessViewController : UIViewController <AVCaptureVideoDataOutputSampleBufferDelegate>
